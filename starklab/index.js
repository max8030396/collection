$(document).ready(function() {
  ...
  //能量條表底部文字
  const labelWord = ['利益', '成長', '效能', '高效', '高效能', '帶動' , '穩定', '穩定的', '人傑' , '上升'];
      ...
      success: function(res) {
        ...
        switch(dataType) {
          case 'ptt':
            ...
            // if(mobileMode) {$newsBar.css('left', '33.33%')}
            // console.log('AJAX GET PTT', getNewsValue);
          break;
    
          case 'google':
            getNewsValue = res.news.google;
            // if(mobileMode) {$newsBar.css('left', '0')}
  ...
  function initS2_blockWidth() {
    ...
    $('.s2_block_nav').css('width',`${s2_navWidth}`);//.css('margin', 'auto')
  }
