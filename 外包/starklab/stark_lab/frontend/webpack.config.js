...
let initProject = {
  openPage: 'bot',
  pages: ['bot','botBlog','botBasicHistory', 'botBasicCurrent', 'botTechnicHistory','botTechnicCurrent','botAbout', 'watchCenter']
...
module.exports = (env, argv) => {
  ...
  initProject.pages.map(function(proName) {
    baseConfig.entry[`${proName}`] = path.resolve(__dirname, `./resources/${proName}.js`);
