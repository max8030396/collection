...
//   }
  ...
  function initHtmlTags () {
    $target.append('<div class="calculator"><input type="text" id="inputer" placeholder="' + $config.placeholder + '"><ul class="interface"><li class="btn1">+</li><li class="btn2">-</li><li class="btn3">×</li><li class="btn4">÷</li><li class="clear">C</li><li class="clear-rwd">C</li><li class="btn5">=</li></ul></div>');
  }
